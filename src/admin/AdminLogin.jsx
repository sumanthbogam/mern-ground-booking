...
const AdminLogin = () => {
  ...
  return (
    <div className='min-h-screen flex justify-center items-center bg-blue-200'>
        ...
        <h1 className='text-center text-2xl px-2 py-2'>Admin Login</h1>
        <form>
            <div>
            ...
            <span className='px-3'>not Registered?<button className='text-blue-600 hover:text-blue-800 cursor-pointer px-3 py-3  ' onClick={()=>navigate("/admin/register")}>Register</button></span>

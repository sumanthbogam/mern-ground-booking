...
const AdminRegister = () => {
 ...
 const handleSubmit=async (e)=>{
    e.preventDefault();
    try{const res=await Axios.post("/admin/register",{
      name,email,password
    });
    alert(res.data.msg);
    ...
    return (
      <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-300'   >
        ...
        <h1 className='text-center mb-6  text-2xl' >Admin Register</h1>
          <form className="space-y-4" >
            ...
            <div>
              ...
              <span>already registered?<button className="cursor-pointer text-blue-800 "onClick={()=>navigate("/admin/login")}>Login</button></span>
